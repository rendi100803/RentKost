...
<div class="p-4 sm:ml-64">
    <div class="rounded-lg mt-14">
        <div class="bg-white rounded-lg shadow p-6" id="user">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Statistik Penjualan</h2>
            <div>
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li>
                        <div class="flex items-center">
                            <a href="javascript:void(0);" class="text-sm font-medium text-gray-500 dark:text-gray-400">Statistik Penjualan</a>
                        </div>
                    </li>
                </ol>
            </div>
