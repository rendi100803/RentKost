            ...
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen md:h-screen lg:py-0">
                ...
                <div
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form action="{{ route('register.process') }}" method="POST" class="space-y-4 md:space-y-6">
                            @csrf
                            <div>
                                <label for="name"
                                ...
                                <input
                                    ...
                                    placeholder="Joe Biden" type="text" name="name">
                                @error('name')
                            ...
                            <div>
                                ...
                                <input
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="password" name="password" id="confirm_password" placeholder="Password">
                                @error('password')
                                    <small class="text-red-500">{{ $message }}</small>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    type="password" name="confirm_password" id="confirm_password" placeholder="Password">
                            ...
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">Already have account?<a
